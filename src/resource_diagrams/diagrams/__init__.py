...
high-quality reconstructions (in the style) of or strictly generalizes the four canonical paper
...
#   # ... see README and notebooks for full usage
    ...
    # 3. Reconstruct the fixed-point diagram (central result of Paper I §6 style) from Python
...
__all__ = [
    ...
    "from_morphism",
    "id_wire",
    # Structural diagram review (illustrative safety geometry aids for reviews)
    "SafetyAnalyzer",
    "SecurityFinding",
    "SecurityReport",
    "analyze_safety_geometry",
