...
This single fact is central to realizing the fixed-point construction idea
from Paper I p.25-26 in a purely diagrammatic way:
the self-applicator (Φ in the paper) can be built by forking the program wire with Δ
...
class SupportsCustomCopy(Protocol):
    ...
    for the purposes of the fixed-point construction ideas.
    """
...
class DataService:
    ...
    @classmethod
    def register_copier(cls, obj: Object, copier: Callable[[Any], tuple[Any, Any]]) -> None:
    ...
    def is_basic_data(value: Any) -> bool:
        ...
        triangles, enabling the fixed-point construction to be expressed diagrammatically
    ...
    def copy_law_holds(cls, value: Any, obj: Object) -> bool:
        ...
        For programs this corresponds to the axiom used in the paper's graphical argument for fixed points.
