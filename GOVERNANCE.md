...
- Fidelity to the cited papers (especially Paper I) is a core value. Contributions that strengthen or clarify this fidelity (e.g., via `tests/paper_laws.py`) are particularly valued.
...
- Strengthening of paper-law verification and reproducibility.

## Review Process
Pull requests are reviewed for:
- Correctness and fidelity to the formal foundations
