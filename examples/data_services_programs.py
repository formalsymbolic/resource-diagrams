...
def main() -> None:
    ...
    print("   copy(policy) → copy1 and copy2 are distinct references to the same value")
...
```"""
    ...
    # ------------------------------------------------------------------
    print("Why this matters (illustrative structural observation)")
    print("-" * 72)
    print(
        "When a policy or prompt is copied into several agent branches or\n"
        "tool contexts, the diagram records (in this model) where each copy lives and\n"
