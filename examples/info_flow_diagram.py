...
def main() -> None:
    ...
    policy_chan = InformationChannel("agent_policy", copyable=True, description="core instructions + tool specs")
    secret_chan = InformationChannel("user_credential", copyable=False, description="private fact from query")
    ...
    print("--- Illustrative structural note ---")
