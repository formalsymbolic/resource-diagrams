...
- Transcriptions of real codebases are manual and best-effort. They are aids to thinking, not formal verifications or proofs.
...
This playbook is deliberately narrow. Its goal is to make one high-leverage distinction (policy copying lifetime vs one-way channel lifetime) visible and countable in agent diagrams.