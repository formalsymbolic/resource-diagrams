...
# The diagram illustrating the graphical argument is in examples/fixed_point_demo.py
...
# between the diagrammatic constructions (in the style of the papers) and the Python objects remains transparent.
#
...
# render reconstructions in the style of the constructions from the papers (and your own models)
...
print("models.build_simple_react_diagram illustrative commentary (excerpt):")
